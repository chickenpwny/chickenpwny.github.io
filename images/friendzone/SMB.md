...
Usage: smbclient service <password>                                                                                 
  ...
  -D, --directory=DIR                       Start from directory                                     -c, --command=STRING                      Execute semicolon separated commands                     -b, --send-buffer=BYTES                   Changes the transmit/send buffer                       
...
```
sudo nmap -sU -sS --script smb-enum-shares.nse -p U:137,T:139 IP_ADDR
